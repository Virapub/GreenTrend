...
const products = [ 
  {
    ...
    affiliateLink: "https://amzn.to/4eZ853i",
  ...
  },
  {
    ...
    category: "Low Budget",
    categorySlug: "low-budget",
    affiliateLink: "https://www.amazon.com/dp/B08Y6HV4DY?tag=greentrend08-20",
    image: "https://m.media-amazon.com/images/I/5173SHrfbyL._SL1024_.jpg",
    rating: 4.2,
    features: [
      "Touchless operation for germ-free use",
      "Adjustable soap volume (3 levels)",
  ...
  },
  {
    ...
    category: "Low Budget",
    categorySlug: "low-budget",
    affiliateLink: "https://www.amazon.com/dp/B08KHN7SS4?tag=greentrend08-20",
    image: "https://m.media-amazon.com/images/I/81aAamdevaL._SL1500_.jpg",
    rating: 4.3,
    features: [
      "Strong magnetic back for secure hold",
      "Multi-tier design for various items",
  ...
  },
  {
    ...
    category: "Low Budget",
    categorySlug: "low-budget",
    affiliateLink: "https://www.amazon.com/dp/B093F9RY28?tag=greentrend08-20",
    image: "https://m.media-amazon.com/images/I/61IK+zdG-IL._SL1200_.jpg",
    rating: 4.6,
    features: [
      "USB rechargeable for cordless convenience",
      "One-button operation for ease of use",
      "Easy to clean components",
      "Portable design for small kitchens or travel",
  ...
  },
  {
    ...
    category: "Low Budget",
    categorySlug: "low-budget",
    affiliateLink: "https://www.amazon.com/dp/B00V5IM580?tag=greentrend08-20",
    image: "https://m.media-amazon.com/images/I/313SCZswZZL.jpg",
    rating: 4.7,
    features: [
      "Tare function for zeroing containers",
      "Multiple unit conversion (g, oz, ml, lb)",
      "Clear LCD display",
